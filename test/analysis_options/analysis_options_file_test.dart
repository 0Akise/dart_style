    ...
    group('readAnalysisOptionsOptions()', () {
        ...
        test('resolves "package:" includes', () async {
            var testFS = TestFileSystem({
                ...
                '|b|b_options.yaml': analysisOptions(include: 'package:c/c_options.yaml', other: {'b': 'from b'}),
        ...
        test('throws on a "package:" include with no package resolver', () async {
            var testFS = TestFileSystem({'options.yaml': analysisOptions(include: 'package:foo/options.yaml')});
        ...
        test('throws on a "package:" resolution failure', () async {
            ...
            expect(
                readAnalysisOptions(testFS, TestFileSystemPath('options.yaml'), resolvePackageUri: failingResolver),
                throwsA(isA<PackageResolutionException>()),
            );
        });
    });
...
Object? _pageWidth(AnalysisOptions options) => (options['formatter'] as Map<Object?, Object?>?)?['page_width'];
