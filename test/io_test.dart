...
void main() {
    ...
    test("doesn't touch unchanged files", () async {
        await d.dir('code', [d.file('bad.dart', unformattedSource), d.file('good.dart', formattedSource)]).create();
    ...
    if (!Platform.isWindows) {
        ...
        test("doesn't follow file symlinks by default", () async {
            ...
            Link(p.join(d.sandbox, 'code', 'linked_file.dart')).createSync(p.join(d.sandbox, 'target_file.dart'));
