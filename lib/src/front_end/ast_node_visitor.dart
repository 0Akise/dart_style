...
final class AstNodeVisitor extends ThrowingAstVisitor<void> with PieceFactory {
            ...
            body: () {
                if (node.members.isEmpty) {
                    ...
                    for (var constant in node.constants) {
                        builder.addCommentsBefore(
                            constant.firstNonCommentToken,
                        );
                        builder.add(
                            createEnumConstant(
                                constant,
    ...
    @override
    void visitRepresentationConstructorName(
    ...
    void visitSwitchExpressionCase(SwitchExpressionCase node) {
        ...
        pieces.add(
            CaseExpressionPiece(
                ...
                canBlockSplitBody:
                        !isVersion37 || node.expression.canBlockSplit,
            ),
        );
    }
